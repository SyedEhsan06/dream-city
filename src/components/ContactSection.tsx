        ...
        <div className="w-full md:w-5/12 bg-emerald-800 text-white flex flex-col">
          <div className="p-10 flex-1">
            ...
            <p className="text-emerald-200 mb-8 leading-relaxed">
              Drop your details below and our team will get back to you with
              exact pricing, availability, and to schedule a tour.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="text-sm text-emerald-300 font-medium tracking-wide mb-1">
                    Our Location
                  </div>
              ...
              <div className="p-4 bg-emerald-50 rounded-xl border border-emerald-200 text-emerald-800 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-sm">
                    Interested in Plot{" "}
                    <strong className="text-emerald-900 text-lg ml-1">
                      {formData.plot_interest}
                    </strong>
                  </span>
                </div>
