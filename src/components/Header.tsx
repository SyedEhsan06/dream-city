          ...
          <nav className="hidden lg:flex gap-8 items-center font-bold text-sm text-neutral-500 uppercase tracking-wider">
            ...
            <div className="relative group">
              ...
              {isProjectsOpen && (
                ...
                >
                  <div className="p-2 mb-1 text-[10px] text-neutral-400 font-black tracking-widest">Active Projects</div>
            ...
            <a href="/#highlights" className="hover:text-emerald-700 transition-colors">Highlights</a>
