      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="text-emerald-100 mb-8 text-lg leading-relaxed">
            Clear, transparent pricing with flexible payment options tailored
            for you. Invest in land that appreciates.
          </p>
          <ul className="space-y-4 mb-8">
            ...
            <li className="flex items-center gap-3">
              ...
              <span className="text-lg">
                Clear titles and transparent documentation
              </span>
            </li>
          </ul>
          <button
        ...
        <div className="bg-emerald-800/50 p-10 rounded-3xl border border-emerald-700/50 backdrop-blur-sm">
          ...
          <p className="text-emerald-200 mb-6 leading-relaxed">
            Committed to delivering high-quality plotted developments with
            verified legal status and modern infrastructure.
          </p>
          <div className="flex items-center gap-4 text-sm font-medium text-emerald-300">
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4" /> Verified Legal
            </span>
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4" /> Ready for Registration
            </span>
          </div>
        </div>
      </div>
