        ...
        <div className="w-full md:w-2/3 p-8 lg:p-12 bg-neutral-50">
          <div className="grid sm:grid-cols-2 gap-x-8 gap-y-12">
            {[
              ...
              { icon: <Zap className="w-10 h-10" />, title: "BRIGHT PLACE", desc: "At Dream Park, we are all about plots, all about service, and most of all we are where your life happens!" }
            ].map((prop, index) => (
              <div key={index}>
